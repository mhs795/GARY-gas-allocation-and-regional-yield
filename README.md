...
| **GSOO expansions only** | off / **on** | On: only expansions AEMO counts as committed in the 2026 GSOO/VGPR. Off: every candidate in `expansion_options.csv`, including pre-FID projects from GARY's own market scan. |
